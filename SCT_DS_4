...
sns.countplot(x='Hour', data=df, palette='Set2')  # changed palette
...
if 'Accident_Type' in df.columns:
    ...
    sns.countplot(y='Accident_Type', data=df,
                  ...
                  palette='Paired')  # changed palette
...
if 'State' in df.columns:
    ...
    sns.barplot(x=top_states.index, y=top_states.values, palette='cubehelix')  # changed palette
